...
function Footer() {
  ...
  return (
    <div
      ...
      data-scroll-section
      data-scroll-speed="-.2"
      className="w-full h-screen flex gap-5 p-20"
    >
      <div className="w-1/2 h-full flex flex-col justify-between font-['Neue_Montreal']">
        <div className="heading">
          <h1 className="text-[7vw] uppercase leading-none -mb-5 font-bold tracking-tighter">
            Eye-
          </h1>
          <h1 className="text-[7vw] uppercase leading-none -mb-5 font-bold tracking-tighter">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw] uppercase tracking-tighter leading-none -mb-5 font-bold font-['Neue_Montreal']">
          Presentations
        </h1>
        <div className="main flex justify-between">
          <div className="left-info">
            <div className="dets mt-10 font-['Neue_Montreal']">
              <div className="small-hd mb-3">
                <p>S:</p>
              </div>
            ...
            <div className="copyright mt-20">
              <p>&copy; ochi design 2024 Legal Term</p>
            </div>
          </div>
